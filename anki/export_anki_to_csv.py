...
Usage:
  python scripts/export_anki_to_csv.py
  FLASHCARD_EXCHANGE_DIR=/flashcards python scripts/export_anki_to_csv.py  # in container
...
def export_all_to_tsv(
    ...
    *,
    ...
    # Base CSV columns (stable for round-trip / import)
    ...
    # Build header: base + all field names (union across models, consistent order)
    field_header = sorted(all_field_names)
